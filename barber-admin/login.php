		...
		<div class="login">
			<form class="login-container validate-form" name="login-form" method="POST" action="login.php" onsubmit="return validateLogInForm()">
					...
					if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['signin-button']))
					{
						...
						else
						{
							...
							<div class="alert alert-danger">
								...
								<div class="messages">
									<div>Benutzername und/oder Passwort sind falsch!</div>
								</div>
							</div>
				...
				<div class="form-input">
					...
					<span class="invalid-feedback" id="required_username">Benutzername erforderlich!</span>
				</div>
				...
				<div class="form-input">
					...
					<span class="invalid-feedback" id="required_password">Passwort erforderlich!</span>
				</div>
				
				<!-- SIGN IN BUTTON -->

				<p>
					<button type="submit" name="signin-button" >Anmelden</button>
				</p>

				<!-- FORGOT YOUR PASSWORD LINK -->

				<span class="forgotPW">Passwort vergessen? <a href="#">Setze zurück.</a></span>
			</form>
		</div>
		...
		<footer class="sticky-footer bg-white">
			<div class="container my-auto">
		  		<div class="copyright text-center my-auto">
					<span>Copyright &copy; Barbershop Website by Arion&Betim</span>
		  		</div>
			</div>
	  	</footer>
		<!-- End of Footer -->
