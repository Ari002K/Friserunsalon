            ...
            if(isset($_POST['submit_book_appointment_form']) && $_SERVER['REQUEST_METHOD'] === 'POST')
            {
                ...
                try
                {
                    ...
                    echo "<div class = 'alert alert-success'>";
                        echo "Deine Buchung wurde erfolgreich durchgeführt.";
                    echo "</div>";
                        	...
                        	echo "<div class='itemListElement'>";
                            	echo "<div class = 'item_details'>";
                                	...
                                	echo "<div class = 'item_select_part'>";
                                    	...
                                    	echo "</div>";
                                    ?>
                                    	<div class="select_item_bttn" style="margin-left 2px;">
                                    		<div class="btn-group-toggle" data-toggle="buttons">
												<label class="service_label item_label btn btn-secondary">
													<input type="checkbox"  name="selected_services[]" value="<?php echo $row['service_id'] ?>" autocomplete="off">auswählen
												</label>
											</div>
                                    	</div>
                                    <?php
                ...
                <div>
                    <div class="form-group colum-row row">
                        <div class="col-sm-6">
							...
							<span class = "invalid-feedback">Das Feld ist erforderlich</span>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
							...
							<span class = "invalid-feedback">Ungültige E-Mail</span>
                        </div>
                        <div class="col-sm-6">
                            <input type="tel"  name="client_phone_number" id="client_phone_number" class="form-control" placeholder="Phone number">
							<span class = "invalid-feedback">Ungültige Telefonnummer</span>
						</div>
                    </div>
